...
a persistence unit "CorrecionRieraXavierCajeraJEEPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "CorrecionRieraXavierCajeraJEE\pom.xml":
...
artifact ("CorrecionRieraXavierCajeraJEE.war") is already built. You can build
